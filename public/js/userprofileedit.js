...
window.addEventListener("load", function () {
    ...
    // VALIDACIONES FRONT - EDICION DE USUARIOS 
    ...
    let registroForm = document.querySelector('#edituserprofile-formulario'); // Atrapo el formulario con la clase reserva
    ...
    registroForm.addEventListener('submit', function (e) {
        ...
        if (erroresRegister.length > 0) {
            ...
            let ulErrores = document.querySelector('#registeredit-validator-front')
